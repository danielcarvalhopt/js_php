...
<html lang="en">
  ...
  <body>
    ...
    <p>MarcadoPor: <?php echo $cliente['MarcadoPor'];?></p>
    <p>MarcacaoNumMarcacaoNum: <?php echo $cliente['MarcacaoNum'];?></p>
    <p>MarcacaoData: <?php echo $cliente['MarcacaoData'];?></p>
    <p>Contato: <?php echo $cliente['Contato'];?></p>
    <p>RB: <?php echo $cliente['RB'];?></p>
    <p>PN: <?php echo $cliente['PN'];?></p>
    <p>AQNAQN: <?php echo $cliente['AQN'];?></p>
    <p>AtendimentoAnterior: <?php echo $cliente['AtendimentoAnterior'];?></p>
    <p>AdiadoCancelado: <?php echo $cliente['AdiadoCancelado'];?></p>
    <p>AdiadoCanceladoPQAdiadoCanceladoPQ: <?php echo $cliente['AdiadoCanceladoPQ'];?></p>
    <p>ServicoAgente: <?php echo $cliente['ServicoAgente'];?></p>
    <p>ServicoAgenteNum: <?php echo $cliente['ServicoAgenteNum'];?></p>
    <p>AcompanhamentoAgente: <?php echo $cliente['AcompanhamentoAgente'];?></p>
    <p>AcompanhamentoAgenteNum: <?php echo $cliente['AcompanhamentoAgenteNum'];?></p>
    <p>Premio: <?php echo $cliente['Premio'];?></p>
